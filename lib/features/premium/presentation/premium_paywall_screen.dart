...
/// RevenueCat paywall with real feature value and restore support.
        ...
        SliverPadding(
          ...
          sliver: SliverList.list(
            children: [
              ...
              const SizedBox(height: 16),
              Text(
                'Subscriptions and digital unlocks are processed by Google Play or the App Store. Cancel anytime in store settings.',
                textAlign: TextAlign.center,
...
class _ConfigurationNotice extends StatelessWidget {
  const _ConfigurationNotice({required this.source});
  final String source;

  @override
  Widget build(BuildContext context) => _Notice(
    icon: Icons.settings_outlined,
    text: 'Store setup is not configured in this build. Add the RevenueCat API key and offerings before release. Source: $source',
  );
}
...
class _NoOfferingsNotice extends StatelessWidget {
  const _NoOfferingsNotice();
  @override
  Widget build(BuildContext context) => const _Notice(
    icon: Icons.info_outline,
    text: 'Purchase options are temporarily unavailable. Try again later.',
  );
}
